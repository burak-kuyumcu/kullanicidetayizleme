...
<template>
  <div class="space-y-6">
   ...
   <div class="flex items-center gap-3 mb-6">
      ...
      <button @click="goBack" class="flex items-center justify-center text-[#26303E] hover:text-[#4F359B] transition" aria-label="go gallery">
    ...
    <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
      ...
      <div v-for="photo in photos" :key="photo.id" class="bg-white rounded-xl overflow-hidden shadow-sm border border-slate-100">
